...
/** Parsed ArtPollReply — minimal fields useful for discovery UI. */
 ...
 */
export function buildArtDmx(portAddress: number, sequence: number, data: Uint8Array): Buffer {
...
export function parsePacket(buf: Buffer): ParsedPacket | null {
  ...
  const out: ParsedPacket = { op, raw: buf };
 ...
 */
export function parsePollReply(buf: Buffer): PollReply | null {
