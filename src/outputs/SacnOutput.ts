...
import { SACN_PORT, buildDataPacket, generateCID, multicastGroup } from '../protocols/sacn';
...
export interface SacnOutputConfig extends OutputConfig {
  mode?: SacnMode;
  host?: string | null;
  port?: number;
  sourceName?: string;
...
export class SacnOutput extends Output {
  ...
  _sequences: Map<number, number>;

  constructor(config: SacnOutputConfig = {}) {
