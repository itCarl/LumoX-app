...
export class Output extends EventEmitter {
  ...
  subscribe(universeId) { this.subscribedUniverses.add(universeId); }
  unsubscribe(universeId) { this.subscribedUniverses.delete(universeId); }
  subscribesTo(universeId) {
  ...
  // ---- subclass hooks -------------------------------------------------
  async _openImpl() { throw new Error('Output._openImpl not implemented'); }
  async _closeImpl() { throw new Error('Output._closeImpl not implemented'); }
  _sendImpl(_universe, _data) { throw new Error('Output._sendImpl not implemented'); }
}
