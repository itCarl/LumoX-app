...
contextBridge.exposeInMainWorld('lumox', {
  ...
  scenes: {
    ...
    armFeature:      (id: string, layerId: string, attr: string) => ipcRenderer.invoke('lumox:scenes:armFeature', { id, layerId, attr }),
    unarmFeature:    (id: string, layerId: string, attr: string) => ipcRenderer.invoke('lumox:scenes:unarmFeature', { id, layerId, attr }),
    setFeatureRange: (id: string, layerId: string, attr: string, min: number | null, max: number | null) => ipcRenderer.invoke('lumox:scenes:setFeatureRange', { id, layerId, attr, min, max }),
